          ...
          <div className="space-y-6">
            <div className="relative p-6 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl border border-purple-200/50 dark:border-purple-800/50 shadow-xl">
              ...
              <p className="relative text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                I specialize in <span className="font-semibold text-cyan-600 dark:text-cyan-400">React</span>, <span className="font-semibold text-gray-800 dark:text-gray-200">Next.js</span>, <span className="font-semibold text-sky-600 dark:text-sky-400">Tailwind CSS</span>, <span className="font-semibold text-purple-600 dark:text-purple-400">JavaScript</span>, and <span className="font-semibold text-green-600 dark:text-green-400">Spring Framework</span>. I also work with <span className="font-semibold text-pink-600 dark:text-pink-400">Figma</span> for design, <span className="font-semibold text-indigo-600 dark:text-indigo-400">Java</span>, <span className="font-semibold text-blue-600 dark:text-blue-400">SQL</span>, and <span className="font-semibold text-orange-600 dark:text-orange-400">NoSQL</span> databases, enjoying bringing ideas to life through code.
              </p>
            </div>
